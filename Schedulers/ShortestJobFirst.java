...
public class ShortestJobFirst extends Scheduler {
    ...
    public ShortestJobFirst(Integer nProcesses, Integer contextSwitchingDuration, List<Process> processes)
    {
    ...
    public void simulate()
    {
        ...
        PriorityQueue<Process> arrivalMinHeap = new PriorityQueue<>(nProcesses, new ProcessArrivalComparator());
        arrivalMinHeap.addAll(processes);

        PriorityQueue<Process> burstMinHeap = new PriorityQueue<>(1, new ProcessBurstComparator());
        List<Process> order = new ArrayList<>();

        Printer printer = new Printer("Schedulers.ShortestJobFirst.txt");
