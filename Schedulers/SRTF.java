...
import Comparators.ProcessArrivalComparator;
import Comparators.ProcessBurstComparator;
...
public class SRTF extends Scheduler{
    ...
    public SRTF(List<Process> list, int contextSwitchingDuration) {
    ...
    private void print() {
        ...
        try {
            file = new PrintStream(new File("Schedulers.SRTF.txt"));
        } catch (FileNotFoundException e) {
            e.printStackTrace();
        }
        System.setOut(file);
        System.out.print("Time    Processes.Process\n");
        ...
        for(Process p : info){
            System.out.println("Processes.Process " + p.PID);
        ...
        System.out.println("Average Waiting Time Using Schedulers.SRTF scheduling : " + AverageWaitingTime);
        System.out.println("Average TurnAround Time Using Schedulers.SRTF scheduling : " + AverageTurnAroundTime);
